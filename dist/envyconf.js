(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["envyConf"] = factory();
	else
		root["envyConf"] = factory();
})(this, function() {
...
function envyConf(PREFIX) {
    var localDefaults = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    if ((typeof PREFIX === 'undefined' ? 'undefined' : (0, _typeof3.default)(PREFIX)) === 'object') {
        ;
        var _ref = [PREFIX, null];
        localDefaults = _ref[0];
        PREFIX = _ref[1];
    ...
    var CONFIG = JSON.parse((0, _stringify2.default)(DEFAULTS));
    (0, _assign2.default)(CONFIG, JSON.parse((0, _stringify2.default)(localDefaults)));

    (0, _keys2.default)(ENV).filter(function (k) {
        return k.match(PREFIX_RE);
    }).forEach(function (k) {
        return CONFIG[k.replace(PREFIX_RE, '')] = ENV[k];
    });

    (0, _keys2.default)(CONFIG).forEach(function (k) {
...
function envyLog(PREFIX) {
    ...
    var format = function format(level, message) {
        // console.log(message)
        if (typeof message !== 'string') message = (0, _stringify2.default)(message);
...
(0, _assign2.default)(envyConf, { envyLog: envyLog, envyConf: envyConf });
...
//# sourceMappingURL=envyconf.js.map